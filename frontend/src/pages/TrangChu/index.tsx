...
import { Avatar, Button, Card, Col, Input, List, Row, Space, Tabs, Tag, Typography } from 'antd';
							...
							return (
								<div
									...
									style={{
										...
										boxShadow:
											hoveredId === recordId ? '0 8px 18px rgba(0, 82, 204, 0.12)' : '0 1px 4px rgba(0, 0, 0, 0.06)',
										padding: 20,
										marginBottom: 16,
										cursor: 'pointer',
										gap: 20,
								...
								>
									...
									>
										<div>
											<div
												style={{ color: '#0052cc', fontWeight: 700, fontSize: 18, lineHeight: 1.4, marginBottom: 10 }}
											>
												{record.title}
											</div>
							...
							{leaderboard.map((user) => (
								...
								>
									<Space size={12} align='center'>
										...
										<Avatar size={32} src={user.avatar} style={{ backgroundColor: '#87d068' }}>
											{user.name.charAt(0)}
										</Avatar>
										<span style={{ fontWeight: 500 }} className='leaderboard-name'>
											{user.name}
										</span>
									</Space>
